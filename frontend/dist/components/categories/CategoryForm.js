...
var CategoryForm = function () {
    ...
    var _a = useState(false), showErrorMessage = _a[0], setShowErrorMessage = _a[1];
    var _b = useState(true), isIncomeCategory = _b[0], setIsIncomeCategory = _b[1];
    var _c = useState({
        category: '',
        budget: '',
    ...
    return (_jsx(Box, __assign({ className: classes.root, boxShadow: 4 }, { children: _jsxs("form", __assign({ onSubmit: function () { return handleSubmit; }, className: classes.formLayout }, { children: [_jsxs("div", __assign({ className: classes.textFields }, { children: [_jsx(TextField, { label: 'Category Name', name: 'categoryNameField', value: state.category, onChange: function (e) { handleInput(e); } }, void 0), !isIncomeCategory &&
                            _jsx(TextField, { label: 'Monthly Budget (\u20AC)', name: 'budgetValueField', value: state.budget, onChange: handleInput }, void 0), showErrorMessage && _jsx("p", __assign({ className: classes.errorText }, { children: "Invalid input!" }), void 0)] }), void 0), _jsxs("div", __assign({ className: classes.buttonLayout }, { children: [_jsx(Button, __assign({ type: "submit", variant: "contained", color: "primary" }, { children: "Add" }), void 0), _jsx(Button, __assign({ className: isIncomeCategory ? classes.incomeButton : classes.expensesButton, variant: 'contained', color: 'primary', onClick: handleCategoryChange }, { children: isIncomeCategory ? 'Income' : 'Expense' }), void 0)] }), void 0)] }), void 0) }), void 0));
};
